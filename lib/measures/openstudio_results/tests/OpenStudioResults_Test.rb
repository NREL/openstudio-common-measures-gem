...
class OpenStudioResults_Test < Minitest::Test
  ...
  def test_steam
    ...
    test_name = 'test_steam'
    model_in_path = "#{File.dirname(__FILE__)}/bldg10-up00.osm"
    ...
    # mimic the process of running this measure in OS App or PAT
    epw_path = OpenStudio::Path.new("#{File.dirname(__FILE__)}/USA_AL_Maxwell.AFB.722265_TMY3.epw").to_s
